...
struct Bubble: Identifiable {
    ...
    var scale: CGFloat = 0.0  // Start small and grow
...
// Add a structure for score indicators
struct ScoreIndicator: Identifiable {
    let id = UUID()
...
class ScoreManager {
    ...
    func addScore(playerName: String, score: Int) {
        ...
        scores = scores.sorted() // sort in descending order
